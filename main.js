...
let wishQ = document.querySelector('#items');
 ...
 function addToWishlist(element,productId) {
    ...
    let wishlistItem = new Products(element.parentElement.children[0].src,element.parentElement.children[1].innerText,element.parentElement.children[2].innerText)
